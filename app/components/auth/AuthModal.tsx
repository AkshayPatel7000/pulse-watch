...
export function AuthModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[400px] bg-[#0a0a0a] border-white/10 text-white p-8 shadow-2xl shadow-blue-500/10 ring-1 ring-white/10">
        <DialogHeader className="items-center text-center">
          <div className="p-3 rounded-2xl bg-blue-600 mb-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="px-10 bg-white/5 border-white/10"
                    value={name}
