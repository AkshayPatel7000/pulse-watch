...
3. **Verify Tech Stack**: Ensure you are using:
   - Next.js (App Router)
   - Tailwind CSS 4
   - MongoDB
   - Radix UI
4. **Adhere to Design System**: Check `app/globals.css` for the current color palette and design tokens.
5. **Check Current State**: Run `ls -R` or use `find_by_name` to understand the current file structure and avoid duplication.
